...
root_agent = Agent(
    ...
    instruction=(
        ...
        "     '🎬 **Storyboard Ready for Director Review**:\n"
        ...
        "   - First Frame Anchor (Starting Frame): If preceding shot k-1 exists, invoke tool `parse_terminal_frame(video_path='...shot_prev.mp4')` to extract its last frame as `input_image_path`.\n"
        "   - Last Frame Anchor (Ending Frame): If succeeding shot k+1 exists, invoke tool `parse_initial_frame(video_path='...shot_next.mp4')` to extract its first frame as `end_image_path`.\n"
